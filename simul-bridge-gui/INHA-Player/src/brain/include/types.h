...
static constexpr int MAX_SHARED_ROBOTS = 5;
static constexpr uint8_t SHARED_LABEL_UNKNOWN = 0;
static constexpr uint8_t SHARED_LABEL_OPPONENT = 1;

struct SharedRobotPacket {
    float x = 0.0f;
    float y = 0.0f;
    float confidence = 0.0f;
    uint8_t label = SHARED_LABEL_UNKNOWN;
};
//================================
...
void BrainConfig::handle() {
  // playerRole [field_player, goal_keeper]
  if (playerRole != "field_player" && playerRole != "goal_keeper") {
    throw invalid_argument("player_role must be one of [field_player, goal_keeper]. Got: " + playerRole);
  }

...
KEY_PATH = "soccer-db-f6361-firebase-adminsdk-fbsvc-8f62d394d2.json"
...
class DBManager:
    ...
    def init_firebase(self):
        if not FIREBASE_AVAILABLE:
            print("[DB] DEBUG: FIREBASE_AVAILABLE is False. firebase-admin module likely missing.")
            return
        ...
        # 2. Try Local File
        print(f"[DB] DEBUG: Checking for key file at: {os.path.abspath(KEY_PATH)}")

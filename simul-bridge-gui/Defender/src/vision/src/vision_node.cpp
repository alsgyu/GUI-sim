...
void VisionNode::Init(const std::string &cfg_template_path, const std::string &cfg_path) {
    ...
    if (camera_type_.find("zed") != std::string::npos) {
        ...
        color_topic = "/booster_camera_bridge/StereoNetNode/rectified_image"; // 260125 수정
        depth_topic = "/booster_camera_bridge/StereoNetNode/stereonet_depth"; // v1.5 update에 따라서...
